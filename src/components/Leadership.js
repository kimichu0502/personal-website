    ...
    <div className="section">
      ...
      <div className="leadership">
        ...
        <div class="description">
          <p>
            Collaborated with diverse student teams within Mentorship & Peer Programs, Orientation Transition 
            & Engagement, and Clubs & Leadership Development to assess the 
            impacts of the pandemic on both remote and in-person learning.
            <br />Proactively recommended improvements and voiced opinions, contributing to constructive 
            discussions on current student experiences, challenges, and barriers to participation.
          </p>
        </div>
      </div>
      ...
      <div className="leadership">
        ...
        <div class="description">
          <p>
            Contributed actively in routine meetings, engaging in discussions about upcoming events, addressing 
            challenges, and celebrating successes, demonstrating commitment and collaborative 
